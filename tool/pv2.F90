...
!    module load netdf/4.6.1 
!    module load intel_compilers/oneapi
!    # Full speed run:
!    ifort -O2 pv2.F90 -o pv2.exe -lnetcdf -lnetcdff -lhdf5 -lhdf5_hl -lz -limf -lm
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        print *, 'Reading h, t, u, v from ', trim(infile), fid
        ...
        call get_var4_real (fid, 'h', nx, ny, nw, nt, h_in)
        call get_var4_real (fid, 't', nx, ny, nw, nt, t_in)
        call get_var4_real (fid, 'u', nx, ny, nw, nt, u_in)
        call get_var4_real (fid, 'v', nx, ny, nw, nt, v_in)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        print *, 'data range and resoluiotn: ', hdr    
